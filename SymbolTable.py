...
BUILTIN_FUNCS = ['exit' ,'main', 'print', 'length', 'list', 'scan']
...
# }
#--------------------------------------------------------------------
# symbol_table = SymbolTable(parent=None, function=None)
# var_a = VariableSymbol('int', 'a', True)
# var_b = VariableSymbol('int', 'b', True)
# symbol_table.put(var_a)
# symbol_table.put(var_b)
# params_add = ['x', 'y']
# func_add = FunctionSymbol('int', 'add', params_add)
# params_main = []
# func_main = FunctionSymbol('void', 'main', params_main)
# symbol_table.put(func_add)
# symbol_table.put(func_main)
# #-----------------------------------------------------------------------------------------
# retrieved_symbol = symbol_table.get('a')
# print(retrieved_symbol)  
# symbol_table.mark_as_defined('a')
# symbol_table.print_symbols()
# symbol_table.show_unused_warning()